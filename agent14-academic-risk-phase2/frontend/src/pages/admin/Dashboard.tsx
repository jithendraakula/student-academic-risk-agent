...
export default function AdminDashboard() {
  ...
  return <main className="min-h-screen bg-canvas">
    <header className="border-b border-slate-200 bg-white px-5 py-4 md:px-8"><div className="mx-auto flex max-w-7xl items-center justify-between gap-5"><div><p className="text-xs font-semibold uppercase tracking-[0.14em] text-brand-600">Admin console</p><h1 className="mt-1 text-2xl font-bold tracking-tight text-ink-900">System governance</h1><p className="mt-1 text-sm text-slate-500">Records, assignments, roles, and academic risk configuration</p></div><button type="button" onClick={logout} className="text-sm font-semibold text-slate-500 hover:text-ink-900">Sign out</button></div></header>
